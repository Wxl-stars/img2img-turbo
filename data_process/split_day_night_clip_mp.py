...
def main(image_paths, num_processes=4):
    ...
    save_path = f"s3://sdagent-shard-bj-baiducloud/wheeljack/wuxiaolei/img_translation/data/e171_day_{day_num}_night_{night_num}_{TODAY}.json"
...
if __name__ == "__main__":
    ...
    print("front images: ", len(front_path_list))  # 9283106
    # 只处理前视图
    main(front_path_list, 1)