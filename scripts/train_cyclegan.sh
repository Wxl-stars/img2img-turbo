...
accelerate launch --multi_gpu --num_processes 8 --main_process_port 29501 src/train_cyclegan_turbo.py   --pretrained_model_name_or_path="stabilityai/sd-turbo" \
    ...
    --dataset_folder "s3://sdagent-shard-bj-baiducloud/wheeljack/wuxiaolei/img_translation/data/2024-12-26/day_nigh_dusk_raniy_snowy_foggy_goodday_goodnight_all.json" \
